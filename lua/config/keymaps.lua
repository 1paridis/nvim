...
map({ "n", "v" }, "<leader>cf", function() require("conform").format { async = true } end, { desc = "Format Document / Selection" })
...
map("n", "<leader>e", "<cmd>Neotree toggle reveal<cr>", { desc = "Neo-tree: Toggle and reveal current file" })
